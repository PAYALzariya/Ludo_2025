...
{
    public static AdsManager _adsManager;
    ...
    private void Awake()
    {
      /*  if (_adsManager != null && _adsManager != this)
        {
            Destroy(gameObject);
            return;
        }*/
    ...
    public void LoadBannerAd()
    {
        ...
        adRequest.Keywords.Add("merge-game");
    ...
    public void RewardedAdEvents(RewardedAd ad)
    {
        ...
        ad.OnAdFullScreenContentFailed += (AdError error) =>
        {
            Debug.LogError("Rewarded ad failed to open full screen content " +
                           "with error : " + error);
        }; // 🔥 THIS IS THE ONE WHERE YOU GIVE THE REWARD!
    ...
    {
        Debug.Log("reward 1");
        CurrencyManager.Instance.AddAdmobBitCoin();
    }
